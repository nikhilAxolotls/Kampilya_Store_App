...
class _OrderdetailsScreenState extends State<OrderdetailsScreen> {
  ...
  AssignriderController assignriderController = Get.put(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: GetBuilder<OrderdetailController>(
        builder: (context) {
                                    ...
                                    Expanded(
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(width: 5),
                                          Text(
                                            "${currency}${(double.parse(orderdetailController.orderdetailsinfo!.orderdata.orderProducts[orderdetailController.currentIndex].productPrice) * double.parse(orderdetailController.orderdetailsinfo!.orderdata.orderProducts[orderdetailController.currentIndex].productQuantity.toString() ?? "0")).toStringAsFixed(2)}",
                                            style: TextStyle(
                                              fontFamily: FontFamily.gilroyBold,
                                              fontSize: 14,
                                              color: Colors.grey,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                OrderInfo(
                                  title: "Subtotal".tr,
                                  subtitle:
                                      "${orderdetailController.orderdetailsinfo?.orderdata.orderSubTotal} ${currency}",
                                ),

                                OrderInfo(
                                  title: "Delivery Charge".tr,
                                  subtitle:
                                      "${orderdetailController.orderdetailsinfo?.orderdata.deliveryCharge} ${currency}",
                                ),
                                ...
                                orderdetailController
                                    ...
                                    ? OrderInfo(
                                        ...
                                        subtitle:
                                            "${orderdetailController.orderdetailsinfo?.orderdata.couponAmount} ${currency}",
                                      )
                                    : SizedBox.shrink(),
                                ...
                                orderdetailController
                                    ...
                                    ? OrderInfo(
                                        ...
                                        subtitle:
                                            "${orderdetailController.orderdetailsinfo?.orderdata.wallAmt}  ${currency}",
                                      )
                                    : SizedBox.shrink(),
                                ...
                                OrderInfo(
                                  ...
                                  subtitle:
                                      "${orderdetailController.orderdetailsinfo?.orderdata.orderStatus}",
                                ),
                                OrderInfo(
  ...
  OrderInfo({String? title, subtitle, int maxLine = 2}) {
    return Row(
