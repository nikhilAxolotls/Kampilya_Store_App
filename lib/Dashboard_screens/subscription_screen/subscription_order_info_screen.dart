...
class _PrescriptiondetailsScreenState extends State<PrescriptiondetailsScreen> {
  ...
  PrescriptiondetailsController prescriptiondetailsController = Get.put(
    PrescriptiondetailsController(),
  );
  AssignriderController assignriderController = Get.put(
    AssignriderController(),
  );
  PrecompletedorderController precompletedorderController = Get.put(
    PrecompletedorderController(),
  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: GetBuilder<PrescriptionhistoryController>(
          builder: (context) {
